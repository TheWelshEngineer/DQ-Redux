...
public class Description implements Serializable {
	...
	public String getWandDescriptionBase() {
		return String.format("This is a %s %s wand inlaid with %s.", wandAdjective, mainAdjective, wandDecoration);
	}
	...
	public String randomWandAdjective() {
		switch(ExtraMaths.diceRoll(1, 8)) {
		case 1: return "chipped";
		case 2: return "frazzled";
		case 3: return "pristine";
		case 4: return "intricate";
		case 5: return "threadbare";
		case 6: return "simple";
		case 7: return "homely";
		case 8: return "jagged";
		default: return "chipped";
		}
	}
	...
	public String randomWandDecoration() {
		switch(Dice.d8.roll()) {
		case 1: return "amethyst crystals";
		case 2: return "golden runes";
		case 3: return "silver runes";
		case 4: return "bismuth clusters";
		case 5: return "copper wire";
		case 6: return "living fire";
		case 7: return "polished seaglass";
		case 8: return "silver wire";
		default: return "amethyst crystals";
		}
	}
