...
public class LightningTrap extends Trap {
	...
	public LightningTrap(int x, int y, int z) {
		super(x, y, z);
	}

	@Override
	public Effect effect() {
		return FactoryManager.getEffectFactory().electrified(3+z+ Dice.d6.roll());
	}

	@Override
	public Effect exploitEffect() {
		return FactoryManager.getEffectFactory().arcWard(10);
	}
