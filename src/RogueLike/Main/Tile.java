...
public enum Tile {
    ...
    MERCHANT_FLOOR(
            (char) 250, /*AsciiPanel.yellow*/ new Color(173, 146, 125), "A rocky cave floor."),
    WALL(
            (char) 177, /*AsciiPanel.yellow*/
            new Color(173, 146, 125),
            "A rocky cave wall. Looks breakable."),
    ...
    STAIRS_EXIT(
            ...
            "A rough stone staircase that leads out of the caves."),
    ...
    PIT(
            ...
            "A deep chasm opens here. You can't see the bottom.."),
    ACID_GAS((char) 176, ExtendedAsciiPanel.apple, "A cloud of caustic gas is swirling here."),
    PARALYZE_GAS(
            (char) 176, ExtendedAsciiPanel.paralyzed, "A cloud of paralytic gas is swirling here."),
    CONFUSE_GAS((char) 176, ExtendedAsciiPanel.pink, "A cloud of confusion gas is swirling here."),
    MIXED_GAS(
            (char) 176, ExtendedAsciiPanel.orange, "A cloud of alchemical murk is swirling here."),
    FUNGUS_WALL(
            (char) 177,
            ExtendedAsciiPanel.green,
            "A wall of tangled cave fungus. Looks like you could chop through it."),
    ;
    ...
    public boolean isGas() {
        return this == Tile.ACID_GAS
                || this == Tile.PARALYZE_GAS
                || this == Tile.CONFUSE_GAS
                || this == Tile.MIXED_GAS
                || this == Tile.SMOKE;
    }
