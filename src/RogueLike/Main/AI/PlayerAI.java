...
public class PlayerAI extends CreatureAI {
    ...
    public PlayerAI(
            Player creature,
            NotificationHistory notificationsHandle,
            FieldOfView fov,
    ...
    public void decodeAction(int action) {
        ...
        switch (action) {
            case 1:
                this.creature.moveBy(-1, 0, 0, false);
                actionQueue = new ArrayList<Integer>();
            ...
            case 2:
                ...
                break;
            case 3:
                this.creature.moveBy(0, -1, 0, false);
                actionQueue = new ArrayList<Integer>();
            ...
            case 4:
                ...
                break;
            case 5:
                this.creature.moveBy(-1, -1, 0, false);
                actionQueue = new ArrayList<Integer>();
            ...
            case 10:
                if (this.itemToProcess() != null) {
                    this.creature.drop(itemToProcess);
                    System.out.println(
                            this.toString() + " uses [Drop " + itemToProcess.toString() + "]");
                    this.setItemToProcess(null);
                }
                actionQueue = new ArrayList<Integer>();
                break;
            case 11:
                if (this.itemToProcess() != null) {
                    this.creature.eat(itemToProcess);
                    System.out.println(
                            this.toString() + " uses [Eat " + itemToProcess.toString() + "]");
                    this.setItemToProcess(null);
                }
                actionQueue = new ArrayList<Integer>();
                break;
            case 12:
                if (this.itemToProcess() != null) {
                    this.creature.equip(itemToProcess);
                    System.out.println(
                            this.toString() + " uses [Equip " + itemToProcess.toString() + "]");
                    this.setItemToProcess(null);
                }
                actionQueue = new ArrayList<Integer>();
                break;
            ...
            case 14:
                if (this.itemToProcess() != null) {
                    this.creature.throwItem(itemToProcess, processX, processY, processZ);
                    System.out.println(
                            this.toString()
                                    + " uses [Throw "
                                    + itemToProcess.toString()
                                    + "] at: ("
                                    + processX
                                    + ","
                                    + processY
                                    ...
                                    + ")");
                    this.setItemToProcess(null);
                    this.setProcessX(null);
                    this.setProcessY(null);
                    this.setProcessZ(null);
                }
                actionQueue = new ArrayList<Integer>();
                break;
            case 15:
                if (this.itemToProcess() != null) {
                    this.creature.quaff(itemToProcess);
                    System.out.println(
                            this.toString() + " uses [Quaff " + itemToProcess.toString() + "]");
                    this.setItemToProcess(null);
                }
                actionQueue = new ArrayList<Integer>();
                break;
            case 16:
                if (this.itemToProcess() != null) {
                    this.creature.castSpell(spellToProcess, processX, processY, itemToProcess);
                    System.out.println(
                            this.toString()
                                    + " uses [Cast "
                                    + itemToProcess.toString()
                ...
                break;
            case 17:
                this.creature.search(12, false);
                System.out.println(this.toString() + " uses [Search Area]");
                actionQueue = new ArrayList<Integer>();
                break;
            case 18:
                if (this.creatureToProcess() != null) {
                    this.creature.rangedWeaponAttack(creatureToProcess);
                    System.out.println(
                            this.toString()
                                    + " uses [Ranged Attack: "
                                    + creatureToProcess.toString()
                                    + "]");
                    this.setCreatureToProcess(null);
                }
                actionQueue = new ArrayList<Integer>();
                break;
                //
            case 19:
                this.creature.moveBy(0, 0, -1, false);
                actionQueue = new ArrayList<Integer>();
                System.out.println(this.toString() + " uses [Move Upstairs]");
                break;
            case 20:
                this.creature.moveBy(0, 0, 1, false);
                actionQueue = new ArrayList<Integer>();
                System.out.println(this.toString() + " uses [Move Downstairs]");
                break;
            default:
                this.creature.idle();
                System.out.println(this.toString() + " uses [Idle]");
