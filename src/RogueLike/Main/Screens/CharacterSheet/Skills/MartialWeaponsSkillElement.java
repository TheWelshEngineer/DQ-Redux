...
public class MartialWeaponsSkillElement extends SkillElement {
    ...
    protected String descriptionLevel1() {
        return String.format(
                "Martial Weapons I: You add your proficiency bonus (+%s) to attack rolls made with"
                        + " Martial Weapons.",
    ...
    protected String descriptionLevel2() {
        return String.format(
                "Martial Weapons II: You add your proficiency bonus (+%s) to damage rolls made with"
                        + " Martial Weapons.",
                player.proficiencyBonus());
    }
    ...
    protected String descriptionLevel3() {
        return "Martial Weapons III: Critical hits with Martial Weapons deal 3x damage (up from"
                + " 2x).";
    }
}
