...
public class StealthSkillElement extends SkillElement {
    ...
    protected String descriptionLevel1() {
        return String.format(
                "Stealth I: You add your proficiency bonus (+%s) to checks made to avoid waking"
                        + " sleeping monsters.",
    ...
    protected String descriptionLevel2() {
        return String.format(
                "Stealth II: Whenever you Search, you expend %s Mana to become Invisible for %d"
                        + " turns.",
    ...
    protected String descriptionLevel3() {
        return "Stealth III: Attacks you make whilst Invisible are always considered to be critical"
                + " hits.";
    }
}
