...
public class Zone1Screen implements Screen {
    ...
    public void displayOutput(ExtendedAsciiPanel terminal) {
        ...
        terminal.writeCenter(
                "mithril mine, but they were sealed off after the lower levels were", y++);
        terminal.writeCenter(
                "discovered to be full of monsters. Eitak, the Dwarvern King predicts that", y++);
        terminal.writeCenter(
                "the ruffians who stole the Ancient Axe fled down into these tunnels..", y++);
        y++;
