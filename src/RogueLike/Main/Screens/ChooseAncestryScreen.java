...
public class ChooseAncestryScreen implements Screen {
    ...
    public void displayOutput(ExtendedAsciiPanel terminal) {
        ...
        terminal.write(
                String.format(
                        "%c %c Human %c      %c",
                        borderVertical, humanLeft, humanRight, borderVertical),
                5,
                y++);
        terminal.write(
        ...
        terminal.write(
                String.format(
                        "%c %c Elf %c        %c",
                        borderVertical, elfLeft, elfRight, borderVertical),
                5,
                y++);
        terminal.write(
                String.format("%c                %c", borderVertical, borderVertical), 5, y++);
        terminal.write(
                String.format(
                        "%c %c Dwarf %c      %c",
                        borderVertical, dwarfLeft, dwarfRight, borderVertical),
                5,
                y++);
        terminal.write(
                String.format("%c                %c", borderVertical, borderVertical), 5, y++);
        terminal.write(
                String.format(
                        "%c %c Orc %c        %c",
                        borderVertical, orcLeft, orcRight, borderVertical),
                5,
                y++);
        terminal.write(
                String.format("%c                %c", borderVertical, borderVertical), 5, y++);
        terminal.write(
                String.format(
                        "%c %c Dragonborn %c %c",
                        borderVertical, dragonbornLeft, dragonbornRight, borderVertical),
                5,
                y++);
        terminal.write(
                String.format(
        ...
        if (check == 0) {
            ...
            terminal.writeCenter(
                    "Jack of All Trades: You begin your adventure with an extra Skill Point.",
                    y += 1);
            y++;
        } else if (check == 1) {
            ...
            terminal.writeCenter(
                    "up, you were tutored in magic as is the elven tradition.", y += 1);
            terminal.writeCenter(
                    "As such, you find it easier to tap into nearby leylines.", y += 1);
            y++;
            y++;
            terminal.writeCenter("+||+ Ancestry Trait +||+", y += 1);
            y++;
            terminal.writeCenter(
                    "Arcane Academia: You gain a greater bonus to your maximum", y += 1);
            ...
            terminal.writeCenter(
                    "inherited their rocky constitution. Literally - your body", y += 1);
            ...
            terminal.writeCenter(
                    "There's nothing you won't dig your tusks into at least once!", y += 1);
            y++;
            y++;
            terminal.writeCenter("+||+ Ancestry Trait +||+", y += 1);
            y++;
            terminal.writeCenter(
                    "Iron Stomach: You recover a small portion of Health Points", y += 1);
            terminal.writeCenter(
                    "whenever you eat food. The recovered HP increases based on", y += 1);
            ...
            terminal.writeCenter(
                    "blessed by a dragon before your birth. You are covered in", y += 1);
            ...
            y++;
            terminal.writeCenter(
                    "Draconic Descendant: You are resistant to Fire damage, and begin", y += 1);
        ...
        terminal.writeCenter(
                String.format(
                        "-- [%s / %s]: Move Selection | [%s]: Confirm and Continue --",
