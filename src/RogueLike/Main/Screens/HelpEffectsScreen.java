...
public class HelpEffectsScreen implements Screen {
    ...
    public void displayOutput(ExtendedAsciiPanel terminal) {
        ...
        terminal.write(
                "Mind Vision: Temporarily allows you to see creatures through walls.", x, y++);
        terminal.write(
                "Levitating: Temporarily lets you float over ground hazards and see over tall"
                        + " grass.",
                x,
                y++);
        terminal.write(
                "Chill Ward: Applies Frozen to nearby enemies and temporarily grants frost",
                x,
                y++);
        terminal.write(
                "resistance, as well as improving your saving throws vs. frost effects.",
                x + 12,
                y++);
        terminal.write(
                "Magma Ward: Applies Ignited to nearby enemies and temporarily grants fire",
                x,
                y++);
        terminal.write(
                "resistance, as well as improving your saving throws vs. fire effects.",
                x + 12,
                y++);
        terminal.write(
                "Arc Ward: Deals shock damage to nearby enemies and temporarily grants shock",
                x,
                y++);
        terminal.write(
                "resistance, as well as improving your saving throws vs. shock effects.",
                x + 10,
                y++);
        ...
        terminal.write(
                "Corroded: Deals acid damage over time and temporarily reduces Armour Class.",
                x,
                y++);
        terminal.write("Blinded: Temporarily reduces your range of vision.", x, y++);
        terminal.write(
                "Devoured: Deals chaos damage over time, and drains mana over time.", x, y++);
        ...
        terminal.write(
                "Frozen: Deals frost damage, then temporarily makes you unable to move.", x, y++);
