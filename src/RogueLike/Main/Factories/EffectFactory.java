...
public class EffectFactory {
    ...
    public Effect magicMissile(Creature reference) {
        Effect missile =
                new Effect(1, null, true, reference, ' ', null) {
                    public void start(Creature creature) {
                        ...
                        Damage damage =
                                new Damage(damageAmount, false, DamageType.MAGIC, getThis(), true);
                        creature.world()
                                .setParticleAtLocation(
                                        creature.ai()
                                                .factory
                                                .particleFactory
                                                .sparkle(ExtendedAsciiPanel.lilac, 2),
                                        creature.x(),
                                        creature.y(),
                                        creature.z());
                        creature.damage(
                                damage,
                                String.format(
                                        "Killed by %s using Magic Missile", reference.name()));
                    }
                };
                ...
                new Effect(1, null, true, reference, ' ', null) {
                    public void start(Creature creature) {
                        ...
                        if (creature == reference) {
                            ...
                            Damage damage =
                                    new Damage(amount, false, DamageType.PHYSICAL, getThis(), true);
                                    ...
                                    creature.world()
                                            .setParticleAtLocation(
                                                    creature.ai()
                                                            .factory
                                                            .particleFactory
                                                            .blast(ExtendedAsciiPanel.lilac, 2),
                                                    creature.x(),
                                                    creature.y(),
                                                    creature.z());
                                    creature.damage(damage, "Killed by kinetic energy");
    ...
    public Effect archmagesAegis(Creature reference) {
        Effect archmagesAegis =
                new Effect(1, "Archmage's Aegis", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int duration_ = 10;
                        if (reference.evocationLevel() >= 1) {
    ...
    public Effect findTraps() {
        Effect findTraps =
                new Effect(0, null, false, null, ' ', null) {
                    public void start(Creature creature) {
                        int count = 0;
                        for (Point p :
                                new Square(
                            ...
                            if (p.x < 0
                                    || p.y < 0
                                    || p.x > creature.world().width()
                                    || p.y > creature.world().height()) {
                                continue;
                            }
    ...
    public Effect firebolt(Creature reference) {
        Effect firebolt =
                new Effect(1, "Firebolt", true, null, ' ', null) {
                    public void start(Creature creature) {
                        ...
                        Damage damage =
                                new Damage(damageAmount, false, DamageType.FIRE, getThis(), true);
                            ...
                            creature.world()
                                    .setParticleAtLocation(
                                            creature.ai()
                                                    .factory
                                                    .particleFactory
                                                    .fire(ExtendedAsciiPanel.orange, 2),
                                            creature.x(),
                                            creature.y(),
                                            creature.z());
                            creature.damage(
                                    damage,
                                    String.format("Killed by %s using Firebolt", reference.name()));
                                ...
                                creature.addEffect(
                                        (Effect)
                                                reference
                                                        ...
                                                        .factory
                                                        .effectFactory
                                                        .ignited(reference.proficiencyBonus() * 2)
                                                        .clone());
                            }
                        } else {
                            creature.notify(
                                    String.format("The %s's spell misses you.", reference.name()));
                            reference.notify(
                                    String.format("Your spell misses the %s.", creature.name()));
                        }
                    }
                };
    ...
    public Effect flashfire(Creature reference) {
        Effect flashfire =
                new Effect(1, "Flashfire", true, null, ' ', null) {
                    public void start(Creature creature) {
                        ...
                        if (creature.dexterityRoll() < saveDC) {
                            ...
                            creature.damage(
                                    damage,
                                    String.format(
                                            "Killed by %s using Flashfire", reference.name()));
                        } else {
                            creature.notify(
                                    String.format("You dodge the %s's spell.", reference.name()));
                            reference.notify(
                                    String.format("The %s dodges your spell.", creature.name()));
                        }
                    }
                };
    ...
    public Effect brazierBarrier(Creature reference) {
        Effect brazierBarrier =
                new Effect(1, "Brazier Barrier", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int duration_ = 10;
                        if (reference.pyromancyLevel() >= 1) {
                            duration_ += reference.proficiencyBonus();
                        ...
                        Effect magmaWard_ =
                                reference.ai().factory.effectFactory.magmaWard(duration_);
                        Effect illuminated_ =
                                reference.ai().factory.effectFactory.illuminated(duration_);
        ...
        Effect pyrotechnics =
                new Effect(1, null, true, reference, ' ', null) {
                    public void start(Creature creature) {
                        ...
                        new InstantiatedAoE(
                                        new Square(creature.x(), creature.y(), creature.z(), 3),
                                        creature.world())
                                .affectedCreaturesExcept(reference)
            ...
            public void start(Creature creature) {
                ...
                Damage damage =
                        new Damage(
                                ...
                                false,
                                DamageType.FIRE,
                                player.world().factory().effectFactory,
                                true);
                Damage halfDamage =
                        new Damage(
                                damageAmount / 2,
                ...
                InstantiatedAoE aoe =
                        new InstantiatedAoE(new Cone(source, target, 5, 60.0), player.world());
                                ...
                                c -> {
                                    if (c.dexterityRoll() >= player.intelligenceSaveDC()) {
                                        ...
                                        c.damage(
                                                halfDamage,
                                                String.format(
                                                        "Killed by %s using Dragon's Breath",
                                                        player.name()));
                                    } else {
                ...
                aoe.points.forEach(
                        p -> {
                            if (player.world().tile(p.x, p.y, p.z).canHaveSubtiles()
                                    && Dice.d6.roll() > 2) { // 2 in 3 chance to set tile on fire
                            ...
                            creature.world()
                                    .setParticleAtLocation(
                                            creature.ai()
                                                    .factory
                                                    .particleFactory
                                                    .frost(ExtendedAsciiPanel.water, 2),
                                            creature.x(),
                                            creature.y(),
                                            creature.z());
                            Damage damage =
    ...
    public Effect iceKnife(Creature reference) {
        Effect iceKnife =
                new Effect(1, "Ice Knife", true, null, ' ', null) {
                    public void start(Creature creature) {
                        int attackRoll = reference.intelligenceRoll();
                        if (reference.cryomancyLevel() >= 1) {
                            attackRoll += reference.proficiencyBonus();
                        ...
                        Damage hitDamage =
                                new Damage(
                                        hitDamageAmount, false, DamageType.FROST, getThis(), true);
                        ...
                        if (attackRoll >= creature.armorClass() || attackRoll >= 20) {
                            ...
                            creature.damage(
                                    hitDamage,
                                    String.format(
                                            "Killed by %s using Ice Knife", reference.name()));
                            if (attackRoll >= 20 && reference.cryomancyLevel() >= 3) {
                                Effect cryoCrit =
                                        creature.ai()
                                                .factory
                                                .effectFactory
                                                .frozen(reference.proficiencyBonus());
                                creature.addEffect((Effect) cryoCrit.clone());
                                creature.ai()
                                        .factory
                                        .effectFactory
                                        .spreadEffect(creature, cryoCrit, 1);
                            }
                        } else {
                            creature.notify(
                                    String.format("The %s's spell misses you.", reference.name()));
                        ...
                        if (creature.dexterityRoll() < reference.intelligenceSaveDC()) {
                            ...
                            reference.notify(
                                    String.format(
                                            "The %s is frostbitten by your spell!",
                                            creature.name()));
                            creature.setLastHit(reference);
                            creature.world()
                                    .setParticleAtLocation(
    ...
    public Effect glaciate(Creature reference) {
        Effect glaciate =
                new Effect(1, "Glaciate", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int duration_ = 10;
                        if (reference.cryomancyLevel() >= 1) {
                            duration_ += reference.proficiencyBonus();
                        ...
                        Effect chillWard_ =
                                reference.ai().factory.effectFactory.chillWard(duration_);
                        creature.addEffect((Effect) chillWard_.clone());
                        for (int x = -1; x < 2; x++) {
                            for (int y = -1; y < 2; y++) {
                                if ((creature.creature(
                                                creature.x() + x, creature.y() + y, creature.z())
                                        == null)) {
                                    Creature newWall =
                                            objectFactory.creatureFactory.newIceWall(
                                                    0, reference, false);
                                    creature.ai()
                                            .world
                                            .addCreatureAtLocation(
                                                    newWall,
                                                    creature.x() + x,
                                                    creature.y() + y,
                                                    creature.z());
    ...
    public Effect iceWall(Creature player) {
        Effect wall =
                new Effect(1, null, false, player, ' ', null) {
                    public void start(Creature creature) {
                        player.notify("You summon a wall of ice!");
                        Creature iceWall =
                                objectFactory.creatureFactory.newIceWall(0, player, false);
                        ...
                        if (cx > px && cy > py) {
                            ...
                            if ((creature.creature(cx + 1, cy, creature.z()) == null)) {
                                ...
                                creature.ai()
                                        .world
                                        .addCreatureAtLocation(newWall, cx + 1, cy, creature.z());
                            }
                            ...
                            if ((creature.creature(cx, cy + 1, creature.z()) == null)) {
                                ...
                                creature.ai()
                                        .world
                                        .addCreatureAtLocation(newWall, cx, cy + 1, creature.z());
                            }
                        ...
                        if ((cx > px && cy == py) || (cx < px && cy == py)) {
                            ...
                            if ((creature.creature(cx, cy + 2, creature.z()) == null)) {
                                ...
                                creature.ai()
                                        .world
                                        .addCreatureAtLocation(newWall, cx, cy + 2, creature.z());
                            }
                            if ((creature.creature(cx, cy - 2, creature.z()) == null)) {
                                Creature newWall =
                                        objectFactory.creatureFactory.newIceWall(0, player, false);
                        ...
                        if ((cx == px && cy < py) || (cx == px && cy > py)) {
                            ...
                            if ((creature.creature(cx + 2, cy, creature.z()) == null)) {
                                ...
                                creature.ai()
                                        .world
                                        .addCreatureAtLocation(newWall, cx + 2, cy, creature.z());
                            }
                            if ((creature.creature(cx - 2, cy, creature.z()) == null)) {
                                Creature newWall =
                                        objectFactory.creatureFactory.newIceWall(0, player, false);
    ...
    public Effect chainLightning(Creature reference) {
        Effect lightning =
                new Effect(7, null, true, reference, ' ', null) {
                    public void start(Creature creature) {
                        int saveDC = reference.intelligenceSaveDC();
                        ...
                        creature.world()
                                .setParticleAtLocation(
                                        creature.ai()
                                                .factory
                                                .particleFactory
                                                .shock(ExtendedAsciiPanel.paralyzed, 2),
                                        creature.x(),
                                        creature.y(),
                                        creature.z());
                        Damage damage =
                                new Damage(damageAmount, false, DamageType.SHOCK, getThis(), true);
                        creature.damage(
                                damage,
                                String.format(
                                        "Killed by %s using Chain Lightning", reference.name()));
    ...
    public Effect lightningLance(Creature reference) {
        Effect lightningLance =
                new Effect(1, "Lightning Lance", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        Line l = new Line(reference.x(), reference.y(), creature.x(), creature.y());
                        ArrayList<Creature> targets = new ArrayList<Creature>();
                        for (Point p : l) {
                            // applicationMain.terminal.write((char)15, p.x, p.y,
                            // ExtraColors.paralyzed);
                            if (creature.creature(p.x, p.y, creature.z()) != null
                                    && (p.x != reference.x() && p.y != reference.y())) {
                        ...
                        for (Creature c : targets) {
                            ...
                            Damage damage =
                                    new Damage(
                                            ...
                                            false,
                                            DamageType.SHOCK,
                                            creature.ai().factory.effectFactory,
                                            true);
                            if (c.dexterityRoll() < reference.intelligenceSaveDC()) {
                                ...
                                c.damage(
                                        damage,
                                        String.format(
                                                "Killed by %s using Lightning Lance",
                                                reference.name()));
                            }
                        }
                    }
    ...
    public Effect staticSurge(Creature reference) {
        Effect staticSurge =
                new Effect(1, "Static Surge", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int duration_ = 10;
                        ...
                        Effect electrocharged_ =
                                reference.ai().factory.effectFactory.electrocharged(duration_);
    ...
    public Effect hasteSpell(Creature reference) {
        Effect hasteSpell =
                new Effect(1, "Haste", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int duration_ = 10;
                        if (reference.electromancyLevel() >= 1) {
                            duration_ += reference.proficiencyBonus();
    ...
    public Effect acidBlast(Creature reference) {
        Effect acidBlast =
                new Effect(1, "Acid Blast", true, null, ' ', null) {
                    public void start(Creature creature) {
                        int attackRoll = reference.intelligenceRoll();
                        ...
                        Damage damage =
                                new Damage(damageAmount, false, DamageType.ACID, getThis(), true);
                        if (attackRoll >= creature.armorClass() || attackRoll >= 20) {
                            ...
                            creature.world()
                                    .setParticleAtLocation(
                                            creature.ai()
                                                    .factory
                                                    .particleFactory
                                                    .crossbones(ExtendedAsciiPanel.lime, 2),
                                            creature.x(),
                                            creature.y(),
                                            creature.z());
                            creature.damage(
                                    damage,
                                    String.format(
                                            "Killed by %s using Acid Blast", reference.name()));
                            if (attackRoll >= 20 && reference.alchemancyLevel() >= 3) {
                                reference.addEffect(
                                        reference.ai().factory.effectFactory.restoration());
    ...
    public Effect toxicTransfusion(Creature reference) {
        Effect toxicTransfusion =
                new Effect(1, "Toxic Transfusion", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int attackRoll = reference.intelligenceRoll();
                        int damageAmount = Dice.d6.roll() + reference.intelligenceModifier();
                        int duration_ = 10;
                        ...
                        Effect venomousWard_ =
                                reference.ai().factory.effectFactory.venomousWard(duration_);
                        Effect poisoned_ =
                                reference.ai().factory.effectFactory.poisoned(duration_ / 2);
                        Effect corroded_ =
                                reference.ai().factory.effectFactory.corroded(duration_ / 2);
                        reference.addEffect((Effect) venomousWard_.clone());

                        Damage damage =
                                new Damage(
                                        damageAmount, false, DamageType.POISON, getThis(), false);
                            ...
                            creature.world()
                                    .setParticleAtLocation(
                                            creature.ai()
                                                    .factory
                                                    .particleFactory
                                                    .crossbones(ExtendedAsciiPanel.magenta, 2),
                                            creature.x(),
                                            creature.y(),
                                            creature.z());
                            creature.damage(
                                    damage,
                                    String.format(
                                            "Killed by %s using Toxic Transfusion",
                                            reference.name()));
                            if (attackRoll >= 20 && reference.alchemancyLevel() >= 3) {
                                reference.addEffect(
                                        reference.ai().factory.effectFactory.restoration());
                        ...
                        if (creature.strengthRoll() < reference.intelligenceSaveDC()) {
                            ...
                            reference.notify(
                                    String.format(
                                            "The %s is afflicted by your spell!", creature.name()));
                            creature.setLastHit(reference);
                            creature.world()
                                    .setParticleAtLocation(
                                            creature.ai()
                            ...
                            creature.notify(
                                    String.format("You resist the %s's spell.", reference.name()));
                            reference.notify(
                                    String.format("The %s resists your spell.", creature.name()));
                        }
                    }
                };
    ...
    public Effect refluxBarrier(Creature reference) {
        Effect refluxBarrier =
                new Effect(1, "Reflux Barrier", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int duration_ = 10;
                        if (reference.alchemancyLevel() >= 1) {
                            duration_ += reference.proficiencyBonus();
                        ...
                        Effect causticWard_ =
                                reference.ai().factory.effectFactory.causticWard(duration_);
    ...
    public Effect lifetap(Creature reference) {
        Effect lifetap =
                new Effect(1, "Lifetap", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int amount_ = (int) creature.hp() / 2;
                        Damage drainDamage =
                                new Damage(amount_, false, DamageType.TRUE, null, false);
    ...
    public Effect armorStorm(Creature reference) {
        Effect armorStorm =
                new Effect(1, "Armor Storm", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int attackRoll = reference.intelligenceRoll();
                        ...
                        if (attackRoll >= creature.armorClass() || attackRoll >= 20) {
                            Damage damage =
                                    new Damage(
                                            ...
                                            false,
                                            DamageType.PHYSICAL,
                                            reference.ai().factory.effectFactory,
                                            true);
                            creature.world()
                                    .setParticleAtLocation(
                                            creature.ai()
                                                    .factory
                                                    .particleFactory
                                                    .blast(ExtendedAsciiPanel.white, 2),
                                            creature.x(),
                                            creature.y(),
                                            creature.z());
                            ...
                            creature.damage(
                                    damage,
                                    String.format(
                                            "Killed by %s using Armor Storm", reference.name()));
                            creature.setLastHit(reference);
                            Effect sundered_ =
                                    reference.ai().factory.effectFactory.sundered(stacks_);
                            reference.addEffect((Effect) sundered_.clone());
                            if (attackRoll >= 20 && reference.ferromancyLevel() >= 3) {
                                Effect giantStrength_ =
                                        reference
                                                .ai()
                                                .factory
                                                .effectFactory
                                                .giantStrength(reference.proficiencyBonus());
    ...
    public Effect weaponBolt(Creature reference) {
        Effect weaponBolt =
                new Effect(1, "Weapon Bolt", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int damageAmount = 0;
                        ...
                        if (attackRoll >= creature.armorClass() || attackRoll >= 20) {
                            creature.doAction(
                                    String.format(
                                            "get hit with a spectral %s!",
                                            reference.weapon().name()));
                            creature.setLastHit(reference);
                            creature.world()
                                    .setParticleAtLocation(
                                            creature.ai()
                            ...
                            creature.damage(
                                    damage,
                                    String.format(
                                            "Killed by %s using Weapon Bolt", reference.name()));
                            if (attackRoll >= 20 && reference.ferromancyLevel() >= 3) {
                                Effect giantStrength_ =
                                        reference
                                                .ai()
    ...
    public Effect bladsWard(Creature reference) {
        Effect bladsWard =
                new Effect(1, "Blad's Ward", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        int duration_ = 10;
                        if (reference.ferromancyLevel() >= 1) {
                            duration_ += reference.proficiencyBonus();
                        ...
                        Effect bladeWard_ =
                                reference.ai().factory.effectFactory.bladeWard(duration_);
                        Effect giantStrength_ =
                                reference.ai().factory.effectFactory.giantStrength(duration_);
    ...
    public Effect infuseUpgrade(Creature reference) {
        Effect infuseUpgrade =
                new Effect(1, "Infuse Upgrade", false, reference, ' ', null) {
                    public void start(Creature creature) {
                        ...
                        if (Dice.d100.roll() <= chance) {
                            ...
                            Effect upgradeScroll_ =
                                    reference.ai().factory.effectFactory.upgradeScroll();
    ...
    public Effect maxHealth() {
        Effect maxHealth =
                new Effect(1, null, false, null, ' ', null) {
                    public void start(Creature creature) {
    ...
    public Effect poisoned(int duration) {
        Effect poisoned =
                new Effect(
                        ...
                        null,
                        Effect.poisoned,
                        ExtendedAsciiPanel.getGlyphFromPage(165, 2),
                        ExtendedAsciiPanel.magenta) { // 10
                    public void start(Creature creature) {
                    ...
                    public void update(Creature creature) {
                        ...
                        Damage damage =
                                new Damage(
                                        Dice.d4.roll(), false, DamageType.POISON, getThis(), false);
    ...
    public Effect bleeding(int duration) {
        Effect bleeding =
                new Effect(
                        ...
                        null,
                        Effect.bleeding,
                        ExtendedAsciiPanel.getGlyphFromPage(161, 2),
                        ExtendedAsciiPanel.red) { // 10
                    public void start(Creature creature) {
    ...
    public Effect giantStrength(int duration) {
        Effect giantStrength =
                new Effect(
                        ...
                        null,
                        Effect.giantStrength,
                        ExtendedAsciiPanel.getGlyphFromPage(3, 1),
                        ExtendedAsciiPanel.orange) {
                    public void start(Creature creature) {
        ...
        giantStrength.setDescription(
                "The strength of giants flows through your muscles, granting you a bonus to your"
                        + " strength and armor class.");
    ...
    public Effect beastForm(int duration) {
        ...
        beastForm.setDescription(
                "You've been temporarily transfigured into a bestial form, granting you a bonus to"
                        + " your dexterity and vision radius.");
        return beastForm;
    }
    ...
    public Effect corroded(int duration) {
        Effect corroded =
                new Effect(
                    ...
                    public void update(Creature creature) {
                        ...
                        Damage damage =
                                new Damage(
                                        Dice.d4.roll(), false, DamageType.ACID, getThis(), false);
        ...
        corroded.setDescription(
                "You've been covered in burning acid, which eats away at you with acid damage every"
                        + " turn!");
        return corroded;
    }
    ...
    public Effect causticVapor(int duration) {
        Effect causticVapor =
                new Effect(1, null, true, null, ' ', null) {
                    public void start(Creature creature) {
                        for (int ox = -2; ox < 3; ox++) {
                            for (int oy = -2; oy < 3; oy++) {
                                ...
                                if (creature.tile(nx, ny, creature.z()).canHaveGas()) {
                                    creature.world()
                                            .changeGasTile(nx, ny, creature.z(), Tile.ACID_GAS);
                                }
    ...
    public Effect mindVision(int duration) {
        Effect mindVision =
                new Effect(
                        ...
                        null,
                        Effect.mindVision,
                        ExtendedAsciiPanel.getGlyphFromPage(163, 2),
                        ExtendedAsciiPanel.pink) {
                    public void start(Creature creature) {
        ...
        mindVision.setDescription(
                "Your senses have been expanded beyond the physical, allowing you to telepathically"
                        + " sense the presence of other creatures at any distance.");
        return mindVision;
    }
    ...
    public Effect blinded(int duration) {
        Effect blinded =
                new Effect(
                        ...
                        null,
                        Effect.blinded,
                        ExtendedAsciiPanel.getGlyphFromPage(15, 1),
                        ExtendedAsciiPanel.invisible) {
                    public void start(Creature creature) {
    ...
    public Effect illuminated(int duration) {
        Effect illuminated =
                new Effect(
                        ...
                        Effect.illuminated,
                        ExtendedAsciiPanel.getGlyphFromPage(15, 1),
                        ExtendedAsciiPanel.brightYellow) {
                    public void start(Creature creature) {
        ...
        illuminated.setDescription(
                "You are glowing with a bright light, illuminating your surroundings and letting"
                        + " you see farther.");
        return illuminated;
    }
    ...
    public Effect haste(int duration) {
        Effect haste =
                new Effect(
                        ...
                        null,
                        Effect.haste,
                        ExtendedAsciiPanel.getGlyphFromPage(164, 2),
                        ExtendedAsciiPanel.brightGreen) {
                    public void start(Creature creature) {
        ...
        haste.setDescription(
                "Energy flows through you, allowing you to move at superhuman speeds.");
        return haste;
    }

    public Effect electrocharged(int duration) {
        Effect electrocharged =
                new Effect(
                        duration,
                        "Electrocharged",
                        false,
        ...
        electrocharged.setDescription(
                "You are infused with electrical energy, shocking your enemies for bonus electrical"
    ...
    public Effect levitating(int duration) {
        Effect levitating =
                new Effect(
                        ...
                        null,
                        Effect.levitating,
                        ExtendedAsciiPanel.getGlyphFromPage(162, 2),
        ...
        levitating.setDescription(
                "You are floating in the air, allowing you to glide across pits and trapped floors"
                        + " safely.");
        return levitating;
    }
    ...
    public Effect devoured(int duration) {
        Effect devoured =
                new Effect(
                        ...
                        Effect.devoured,
                        ExtendedAsciiPanel.getGlyphFromPage(162, 2),
                        ExtendedAsciiPanel.brightMagenta) {
                    public void start(Creature creature) {
                    ...
                    public void update(Creature creature) {
                        ...
                        Damage damage =
                                new Damage(
                                        Dice.d4.roll(), false, DamageType.CHAOS, getThis(), false);
        ...
        devoured.setDescription(
                "A devouring curse is eating away at your life force, draining your health and mana"
                        + " every turn!");
        return devoured;
    }
    ...
    public Effect bounce() {
        Effect bounce =
                new Effect(7, null, false, null, ' ', null) {
                    public void start(Creature creature) {
    ...
    public Effect arcaneWard(int duration) {
        ...
        Effect arcaneWard =
                new Effect(
                        ...
                        null,
                        Effect.arcaneWard,
                        ExtendedAsciiPanel.getGlyphFromPage(4, 1),
                        ExtendedAsciiPanel.lilac) {
                    public void start(Creature creature) {
                        creature.doAction("raise a magical shield!");
                        new InstantiatedAoE(
                                        new Square(creature.x(), creature.y(), creature.z(), 1),
                                        creature.world())
                                .affectedCreaturesExcept(creature)
                                .forEach(
                                        c -> {
                                ...
                                creature.world()
                                        .setParticleAtLocation(
                                                creature.ai()
                                                        .factory
                                                        .particleFactory
                                                        .vortex(ExtendedAsciiPanel.green, 2),
                                                target.x(),
                                                target.y(),
                                                target.z());
                    ...
                    public void start(Creature creature) {
                        for (int ox = -2; ox < 3; ox++) {
                            for (int oy = -2; oy < 3; oy++) {
                                int nx = creature.x + ox;
                                int ny = creature.y + oy;
                                if ((creature.tile(nx, ny, creature.z()).canHaveSubtiles())
                                        && creature.item(nx, ny, creature.z()) == null) {
                                    if (ExtraMaths.d10() > 5) {
                                        creature.world()
                                                .changeSubTile(nx, ny, creature.z(), Tile.FIRE);
                                        if (creature.creature(nx, ny, creature.z()) != null) {
                                            creature.creature(nx, ny, creature.z())
                                                    .notify("Roaring flames ignite beneath you!");
                                        }
                                    }
                                }
                                if (creature.creature(nx, ny, creature.z) == null) {
                    ...
                    public void start(Creature creature) {
                        ...
                        for (int ox = -2; ox < 3; ox++) {
                            for (int oy = -2; oy < 3; oy++) {
                                ...
                                if (creature.tile(nx, ny, creature.z()) == Tile.FLOOR
                                        && creature.item(nx, ny, creature.z()) == null) {
                                    if (ExtraMaths.d10() > 4) {
                                        creature.world()
                                                .changeTile(nx, ny, creature.z(), Tile.GRASS_TALL);
                                        if (creature.creature(nx, ny, creature.z()) != null) {
                                            creature.creature(nx, ny, creature.z())
                                                    .notify("Thick foliage springs up around you!");
                                            creature.creature(nx, ny, creature.z())
                                                    .addEffect(paralysed(duration));
                                        }
                                    }
                                }
                            }
    ...
    public Effect invisible(int duration) {
        ...
        invisible.setDescription(
                "A complex set of arcane energies hides you from mortal sight. Attacking or casting"
                    + " a spell will disrupt the fragile balance of this effect, making you visible"
                    + " once more.");
        return invisible;
    }
    ...
    public Effect blink() {
        Effect blink =
                new Effect(8, null, false, null, ' ', null) {
                    public void start(Creature creature) {
                        ...
                        creature.world()
                                .setParticleAtLocation(
                                        creature.ai()
                                                .factory
                                                .particleFactory
                                                .vortex(ExtendedAsciiPanel.pink, 2),
                                        creature.x(),
                                        creature.y(),
                                        creature.z());
                        int mx = 0;
    ...
    public Effect pitFall() {
        Effect pit =
                new Effect(8, null, true, null, ' ', null) {
                    public void start(Creature creature) {
    ...
    public Effect frozen(int duration) {
        Effect frozen =
                new Effect(
                        ...
                        null,
                        Effect.frozen,
                        ExtendedAsciiPanel.getGlyphFromPage(166, 2),
                        ExtendedAsciiPanel.water) {
                    public void start(Creature creature) {
    ...
    public Effect sundered(int duration) {
        Effect sundered =
                new Effect(
                        ...
                        null,
                        Effect.sundered,
                        ExtendedAsciiPanel.getGlyphFromPage(160, 2),
                        ExtendedAsciiPanel.white) {
                    public void start(Creature creature) {
    ...
    public Effect electrified(int duration) {
        Effect electrified =
                new Effect(
                    ...
                    public void start(Creature creature) {
                        ...
                        Damage damage =
                                new Damage(
                                        Dice.d6.roll(), false, DamageType.SHOCK, getThis(), false);
        ...
        electrified.setDescription(
                "An electric shock has disrupted your magical reserves, draining your mana every"
                        + " turn!");
        return electrified;
    }
    ...
    public Effect ignited(int duration) {
        Effect ignited =
                new Effect(
                        ...
                        null,
                        Effect.ignited,
                        ExtendedAsciiPanel.getGlyphFromPage(167, 2),
                        ExtendedAsciiPanel.orange) {
                    public void start(Creature creature) {
                    ...
                    public void update(Creature creature) {
                        ...
                        Damage damage =
                                new Damage(
                                        Dice.d4.roll(), false, DamageType.FIRE, getThis(), false);
        ...
        ignited.setDescription(
                "You have been set on fire, and you are taking fire damage every turn!");
        return ignited;
    }
                                ...
                                bat.world()
                                        .setParticleAtLocation(
                                                bat.ai()
                                                        .factory
                                                        .particleFactory
                                                        .vortex(ExtendedAsciiPanel.white, 2),
                                                bat.x(),
                                                bat.y(),
                                                bat.z());
                            }
    ...
    public Effect magicMappingScroll() {
        Effect map =
                new Effect(2, null, false, null, ' ', null) {
                    public void start(Creature creature) {
    ...
    public void spreadEffect(Creature centre, Effect effect, int radius) {
        for (int x = centre.x() - radius; x <= centre.x() + radius; x++) {
            for (int y = centre.y() - radius; y <= centre.y() + radius; y++) {
                if (centre.creature(x, y, centre.z()) != null
    ...
    public void spreadDamage(
            Creature centre, Damage damage, String cause, int radius, Particle particle) {
        for (int x = centre.x() - radius; x <= centre.x() + radius; x++) {
            for (int y = centre.y() - radius; y <= centre.y() + radius; y++) {
                if (centre.creature(x, y, centre.z()) != null
                        && (x != centre.x() && y != centre.y())) {
