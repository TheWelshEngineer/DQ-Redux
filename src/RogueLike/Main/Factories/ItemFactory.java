...
public class ItemFactory {
    ...
    public Item newGold(int depth, boolean addToWorld) {
        ...
        item.setIsGold(true);
        item.setBaseGoldValue(
                ExtraMaths.diceRoll(ExtraMaths.d12(), ExtraMaths.d100() + 12) * (depth + 1));
    ...
    public Item newRations(int depth, int addToWorld) {
        Item item =
                new Item((char) 233, ExtendedAsciiPanel.paper, "Ration of Food", "Ration of Food");
    ...
    public Item newPasty(int depth, int addToWorld) {
        Item item =
                new Item((char) 233, ExtendedAsciiPanel.smoke, "Dwarven Pasty", "Dwarven Pasty");
    ...
    public Item newClub(int depth, boolean addToWorld) {
        Item item =
                new BasicMeleeWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Club", null, Dice.d4, 25, 400);
    ...
    public Item newGreatclub(int depth, boolean addToWorld) {
        Item item =
                new TwoHandedMeleeWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Greatclub", null, Dice.d10, 125, 404);
        item.setIsSimple(true);
        item.setUsesStrength(true);
    ...
    public Item newMaul(int depth, boolean addToWorld) {
        Item item =
                new TwoHandedMeleeWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Maul", null, Dice.d12, 500, 407);
        item.setIsSimple(true);
        item.setUsesStrength(true);
    ...
    public Item newShortsword(int depth, boolean addToWorld) {
        Item item =
                new BasicMeleeWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Shortsword", null, Dice.d6, 25, 500);
    ...
    public Item newLongsword(int depth, boolean addToWorld) {
        Item item =
                new BasicMeleeWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Longsword", null, Dice.d8, 125, 504);
        item.setIsMartial(true);
        item.setUsesStrength(true);
        item.setStrengthRequirement(14);
        if (addToWorld) {
    ...
    public Item newHalberd(int depth, boolean addToWorld) {
        Item item =
                new TwoHandedMeleeWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Halberd", null, Dice.d10, 125, 505);
        item.setIsMartial(true);
        item.setUsesStrength(true);
        item.setStrengthRequirement(14);
        if (addToWorld) {
    ...
    public Item newRapier(int depth, boolean addToWorld) {
        Item item =
                new BasicFinesseWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Rapier", null, Dice.d6, 25, 601);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
        }
        return item;
    ...
    public Item newGlaive(int depth, boolean addToWorld) {
        Item item =
                new TwoHandedFinesseWeapon(
                        ')', ExtendedAsciiPanel.brightWhite, "Glaive", null, Dice.d10, 125, 604);
        item.setUsesDexterity(true);
        item.setDexterityRequirement(14);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newShortbow(int depth, boolean addToWorld) {
        Item item =
                new ArrowsRangedWeapon(
                        '}', ExtendedAsciiPanel.brightWhite, "Shortbow", null, Dice.d6, 25, 700);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
        }
        return item;
    ...
    public Item newLongbow(int depth, boolean addToWorld) {
        Item item =
                new ArrowsRangedWeapon(
                        '}', ExtendedAsciiPanel.brightWhite, "Longbow", null, Dice.d8, 75, 701);
        item.setUsesDexterity(true);
        item.setDexterityRequirement(12);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newFrostResistanceRing(int depth, boolean addToWorld) {
        Item item =
                new Ring(this.objectFactory, (char) 9, "Ring of Frost Resistance", 5, 250, 1005);
    ...
    public Item newShockResistanceRing(int depth, boolean addToWorld) {
        Item item =
                new Ring(this.objectFactory, (char) 9, "Ring of Shock Resistance", 6, 250, 1006);
    ...
    public Item newPoisonResistanceRing(int depth, boolean addToWorld) {
        Item item =
                new Ring(this.objectFactory, (char) 9, "Ring of Poison Resistance", 7, 250, 1007);
    ...
    public Item newMagicResistanceRing(int depth, boolean addToWorld) {
        Item item =
                new Ring(this.objectFactory, (char) 9, "Ring of Magic Resistance", 9, 250, 1009);
    ...
    public Item newChaosResistanceRing(int depth, boolean addToWorld) {
        Item item =
                new Ring(this.objectFactory, (char) 9, "Ring of Chaos Resistance", 10, 250, 1010);
    ...
    public Item newPotionOfHealing(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        0,
                        "Healing",
                        objectFactory.effectFactory.maxHealth(),
                        false,
                        100,
                        1100);
        if (addToWorld) {
    ...
    public Item newPotionOfMana(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        1,
                        "Mana Restoration",
                        objectFactory.effectFactory.maxMana(),
                        false,
                        100,
                        1102);
        if (addToWorld) {
    ...
    public Item newPotionOfPoison(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        2,
                        "Poison",
                        objectFactory.effectFactory.poisoned(3 + depth + Dice.d6.roll()),
                        true,
                        100,
                        1103);
        if (addToWorld) {
    ...
    public Item newPotionOfGiantStrength(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        3,
                        "Giant Strength",
                        objectFactory.effectFactory.giantStrength(10 + depth + Dice.d4.roll()),
                        false,
                        100,
                        1104);
        if (addToWorld) {
    ...
    public Item newPotionOfInvisibility(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        4,
                        "Invisibility",
                        objectFactory.effectFactory.invisible(10 + depth + Dice.d4.roll()),
                        false,
                        100,
                        1105);
        if (addToWorld) {
    ...
    public Item newPotionOfParalysis(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        5,
                        "Paralysis",
                        objectFactory.effectFactory.paralysed(3 + depth + Dice.d6.roll()),
                        true,
                        100,
                        1106);
        if (addToWorld) {
    ...
    public Item newPotionOfCausticGas(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        this.objectFactory,
                        (char) 13,
                        "Potion of Caustic Gas",
                        6,
                        "Caustic Cloud",
                        objectFactory.effectFactory.causticVapor(3 + depth + Dice.d6.roll()),
                        true,
                        100,
                        1107);
        if (addToWorld) {
    ...
    public Item newPotionOfRestoration(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        7,
                        "Restoration",
                        objectFactory.effectFactory.restoration(),
                        false,
                        100,
                        1108);
        if (addToWorld) {
    ...
    public Item newPotionOfMindVision(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        8,
                        "Mind Vision",
                        objectFactory.effectFactory.mindVision(10 + depth + Dice.d4.roll()),
                        false,
                        100,
                        1109);
        if (addToWorld) {
    ...
    public Item newPotionOfOvergrowth(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        9,
                        "Overgrowth",
                        objectFactory.effectFactory.overgrow(3 + depth + Dice.d6.roll()),
                        true,
                        100,
                        1110);
        if (addToWorld) {
    ...
    public Item newPotionOfCombustion(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        10,
                        "Combustion Cloud",
                        objectFactory.effectFactory.fireball(3 + depth + Dice.d6.roll()),
                        true,
                        100,
                        1111);
        if (addToWorld) {
    ...
    public Item newPotionOfLevitation(int depth, boolean addToWorld) {
        Item item =
                new Potion(
                        ...
                        11,
                        "Levitation",
                        objectFactory.effectFactory.levitating(10 + depth + Dice.d4.roll()),
                        false,
                        100,
                        1112);
        if (addToWorld) {
    ...
    public Item newScrollOfMagicMapping(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Scroll(
                        ...
                        0,
                        objectFactory.spellFactory.magicMappingScroll(reference),
                        150,
                        1200);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newScrollOfIdentify(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Scroll(
                        ...
                        "Scroll of Identify",
                        1,
                        objectFactory.spellFactory.identifyScroll(reference),
                        150,
                        1201);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newScrollOfSummonMonsters(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Scroll(
                        this.objectFactory,
                        (char) 247,
                        "Scroll of Summon Monsters",
                        2,
                        objectFactory.spellFactory.summonMonstersScroll(reference),
                        150,
                        1202);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newScrollOfUpgrade(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Scroll(
                        ...
                        "Scroll of Upgrade",
                        3,
                        objectFactory.spellFactory.upgradeScroll(reference),
                        150,
                        1203);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newScrollOfRemoveCurse(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Scroll(
                        ...
                        4,
                        objectFactory.spellFactory.removeCurseScroll(reference),
                        150,
                        1204);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newScrollOfConfusion(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Scroll(
                        ...
                        "Scroll of Confusion",
                        6,
                        objectFactory.spellFactory.confuseScroll(reference),
                        150,
                        1206);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newMagicMissileWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        1,
                        objectFactory.spellFactory.magicMissile(reference),
                        500,
                        1300);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newForceBlastWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Force Blast",
                        2,
                        objectFactory.spellFactory.forceBlast(reference),
                        500,
                        1301);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newArchmagesAegisWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Archmage's Aegis",
                        3,
                        objectFactory.spellFactory.archmagesAegis(reference),
                        500,
                        1302);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newFindTrapsWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Find Traps",
                        4,
                        objectFactory.spellFactory.findTraps(reference),
                        500,
                        1303);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newFireboltWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Firebolt",
                        5,
                        objectFactory.spellFactory.firebolt(reference),
                        500,
                        1400);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newBrazierBarrierWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Brazier Barrier",
                        6,
                        objectFactory.spellFactory.brazierBarrier(reference),
                        500,
                        1401);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newPyrotechnicsWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        7,
                        objectFactory.spellFactory.pyrotechnics(reference),
                        500,
                        1402);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newFlashfireWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Flashfire",
                        8,
                        objectFactory.spellFactory.flashfire(reference),
                        500,
                        1403);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newDragonsBreathWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        8,
                        objectFactory.spellFactory.dragonsBreath(reference),
                        500,
                        1404);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newFlashFreezeWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Flash Freeze",
                        9,
                        objectFactory.spellFactory.flashFreeze(reference),
                        500,
                        1500);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newIceWallWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Ice Wall",
                        10,
                        objectFactory.spellFactory.iceWall(reference),
                        500,
                        1501);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newIceKnifeWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Ice Knife",
                        11,
                        objectFactory.spellFactory.iceKnife(reference),
                        500,
                        1502);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newGlaciateWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Glaciate",
                        12,
                        objectFactory.spellFactory.glaciate(reference),
                        500,
                        1503);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newChainLightningWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        13,
                        objectFactory.spellFactory.chainLightning(reference),
                        500,
                        1600);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newLightningLanceWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Lightning Lance",
                        14,
                        objectFactory.spellFactory.lightningLance(reference),
                        500,
                        1601);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newStaticSurgeWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Static Surge",
                        15,
                        objectFactory.spellFactory.staticSurge(reference),
                        500,
                        1602);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newHasteWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Haste",
                        16,
                        objectFactory.spellFactory.haste(reference),
                        500,
                        1603);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newAcidBlastWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Acid Blast",
                        17,
                        objectFactory.spellFactory.acidBlast(reference),
                        500,
                        1700);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newToxicTransfusionWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Toxic Transfusion",
                        18,
                        objectFactory.spellFactory.toxicTransfusion(reference),
                        500,
                        1701);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newRefluxBarrierWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Reflux Barrier",
                        19,
                        objectFactory.spellFactory.refluxBarrier(reference),
                        500,
                        1702);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newLifetapWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Lifetap",
                        20,
                        objectFactory.spellFactory.lifetap(reference),
                        500,
                        1703);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newArmorStormWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Armor Storm",
                        21,
                        objectFactory.spellFactory.armorStorm(reference),
                        500,
                        1800);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newBladsWardWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Blad's Ward",
                        22,
                        objectFactory.spellFactory.bladsWard(reference),
                        500,
                        1801);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newWeaponBoltWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        ...
                        "Wand of Weapon Bolt",
                        23,
                        objectFactory.spellFactory.weaponBolt(reference),
                        500,
                        1802);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
    ...
    public Item newInfuseUpgradeWand(int depth, Creature reference, boolean addToWorld) {
        Item item =
                new Wand(
                        this.objectFactory,
                        (char) 33,
                        "Wand of Infuse Upgrade",
                        24,
                        objectFactory.spellFactory.infuseUpgrade(reference),
                        500,
                        1803);
        if (addToWorld) {
            objectFactory.world.addAtEmptyLocation(item, depth);
