...
public class ObjectFactory {
    ...
    private void setUpPotionAppearances() {
        ...
        potionColors.put(
                "Crimson Potion", new Description("crimson", ExtendedAsciiPanel.brightRed));
        ...
        potionColors.put(
                "Charcoal Potion", new Description("charcoal", ExtendedAsciiPanel.brightBlack));
        potionColors.put("Silver Potion", new Description("silver", ExtendedAsciiPanel.white));
        potionColors.put(
                "Cloudy Potion", new Description("cloudy", ExtendedAsciiPanel.brightWhite));
        potionColors.put("Pink Potion", new Description("pink", ExtendedAsciiPanel.brightPink));
        potionColors.put(
                "Emerald Potion", new Description("emerald", ExtendedAsciiPanel.brightGreen));
    ...
    private void setUpWandAppearances() {
        ...
        wandColors.put(
                "Thorn Wand", new Description("thorn wood", ExtendedAsciiPanel.brightMagenta));
        ...
        wandColors.put(
                "Stone Wand", new Description("dungeon-stone", ExtendedAsciiPanel.brightBlack));
        ...
        wandColors.put(
                "Lavender Wand",
                new Description("braided lavender", ExtendedAsciiPanel.lilac)); // 21
        wandColors.put(
                "Heartwood Wand", new Description("heartwood", ExtendedAsciiPanel.kathryn)); // 22
        wandColors.put("Copper Wand", new Description("copper", ExtendedAsciiPanel.copper)); // 23
        wandColors.put(
                "Driftwood Wand", new Description("driftwood", ExtendedAsciiPanel.seafoam)); // 24
    ...
    public Item randomWeapon(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return randomSimpleWeapon(depth, addToWorld);
            case 2:
                return randomMartialWeapon(depth, addToWorld);
            case 3:
                return randomFinesseWeapon(depth, addToWorld);
            case 4:
                return randomRangedWeapon(depth, addToWorld);
            default:
                return randomSimpleWeapon(depth, addToWorld);
        }
    }
    ...
    public Item randomSimpleWeapon(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 8)) {
            case 1:
                return itemFactory.newClub(depth, addToWorld);
            case 2:
                return itemFactory.newDart(depth, addToWorld);
            case 3:
                return itemFactory.newQuarterstaff(depth, addToWorld);
            case 4:
                return itemFactory.newSpear(depth, addToWorld);
            case 5:
                return itemFactory.newGreatclub(depth, addToWorld);
            case 6:
                return itemFactory.newThrowingAxe(depth, addToWorld);
            case 7:
                return itemFactory.newMattock(depth, addToWorld);
            case 8:
                return itemFactory.newMaul(depth, addToWorld);
            default:
                return itemFactory.newClub(depth, addToWorld);
        }
    }
    ...
    public Item randomMartialWeapon(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 9)) {
            case 1:
                return itemFactory.newShortsword(depth, addToWorld);
            case 2:
                return itemFactory.newKnuckleduster(depth, addToWorld);
            case 3:
                return itemFactory.newMace(depth, addToWorld);
            case 4:
                return itemFactory.newThrowingHammer(depth, addToWorld);
            case 5:
                return itemFactory.newLongsword(depth, addToWorld);
            case 6:
                return itemFactory.newHalberd(depth, addToWorld);
            case 7:
                return itemFactory.newWarhammer(depth, addToWorld);
            case 8:
                return itemFactory.newJavelin(depth, addToWorld);
            case 9:
                return itemFactory.newGreatsword(depth, addToWorld);
            default:
                return itemFactory.newShortsword(depth, addToWorld);
        }
    }
    ...
    public Item randomFinesseWeapon(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 7)) {
            case 1:
                return itemFactory.newDagger(depth, addToWorld);
            case 2:
                return itemFactory.newRapier(depth, addToWorld);
            case 3:
                return itemFactory.newFalchion(depth, addToWorld);
            case 4:
                return itemFactory.newBoomerang(depth, addToWorld);
            case 5:
                return itemFactory.newGlaive(depth, addToWorld);
            case 6:
                return itemFactory.newFlamberge(depth, addToWorld);
            case 7:
                return itemFactory.newPairedBlades(depth, addToWorld);
            default:
                return itemFactory.newDagger(depth, addToWorld);
        }
    }
    ...
    public Item randomRangedWeapon(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 7)) {
            case 1:
                return itemFactory.newShortbow(depth, addToWorld);
            case 2:
                return itemFactory.newLongbow(depth, addToWorld);
            case 3:
                return itemFactory.newLightCrossbow(depth, addToWorld);
            case 4:
                return itemFactory.newHeavyCrossbow(depth, addToWorld);
            case 5:
                return itemFactory.newHandCrossbow(depth, addToWorld);
            case 6:
                return itemFactory.newPistol(depth, addToWorld);
            case 7:
                return itemFactory.newCaliver(depth, addToWorld);
            default:
                return itemFactory.newShortbow(depth, addToWorld);
        }
    }
    ...
    public Item randomArmor(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 12)) {
            case 1:
                return itemFactory.newPaddedClothArmor(depth, addToWorld);
            case 2:
                return itemFactory.newLeatherArmor(depth, addToWorld);
            case 3:
                return itemFactory.newStuddedLeatherArmor(depth, addToWorld);
            case 4:
                return itemFactory.newHideArmor(depth, addToWorld);
            case 5:
                return itemFactory.newChainmailArmor(depth, addToWorld);
            case 6:
                return itemFactory.newScaleArmor(depth, addToWorld);
            case 7:
                return itemFactory.newBreastplate(depth, addToWorld);
            case 8:
                return itemFactory.newHalfPlate(depth, addToWorld);
            case 9:
                return itemFactory.newPlateArmor(depth, addToWorld);
            case 10:
                return itemFactory.newRingMail(depth, addToWorld);
            case 11:
                return itemFactory.newChainArmor(depth, addToWorld);
            case 12:
                return itemFactory.newSplintArmor(depth, addToWorld);
            default:
                return itemFactory.newPaddedClothArmor(depth, addToWorld);
        }
    }
    ...
    public Item randomShield(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 3)) {
            case 1:
                return itemFactory.newRoundShield(depth, addToWorld);
            case 2:
                return itemFactory.newTowerShield(depth, addToWorld);
            case 3:
                return itemFactory.newKiteShield(depth, addToWorld);
            default:
                return itemFactory.newRoundShield(depth, addToWorld);
        }
    }
    ...
    public Item randomMimicDrop(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 3)) {
            case 1:
                return randomWeapon(depth, addToWorld);
            case 2:
                return randomArmor(depth, addToWorld);
            case 3:
                return randomShield(depth, addToWorld);
            default:
                return randomWeapon(depth, addToWorld);
        }
    }
    ...
    public void createRandomTrap(Point where) {
        ...
        switch (ExtraMaths.diceRoll(1, 7)) {
            case 1:
                trap = new LightningTrap(where.x, where.y, where.z, world);
                break;
            case 2:
                trap = new FrostbiteTrap(where.x, where.y, where.z, world);
                break;
            case 3:
                trap = new SummoningTrap(where.x, where.y, where.z, world);
                break;
            case 4:
                trap = new BlinkTrap(where.x, where.y, where.z, world);
                break;
            case 5:
                trap = new FireTrap(where.x, where.y, where.z, world);
                break;
            case 6:
                trap = new AcidTrap(where.x, where.y, where.z, world);
                break;
            case 7:
                trap = new SmokeTrap(where.x, where.y, where.z, world);
                break;
            default:
                trap = new FireTrap(where.x, where.y, where.z, world);
                break;
    ...
    public Item randomAmmunition(int depth, int addToWorld) {
        switch (ExtraMaths.diceRoll(1, 3)) {
            case 1:
                return itemFactory.newArrows(depth, addToWorld);
            case 2:
                return itemFactory.newBolts(depth, addToWorld);
            case 3:
                return itemFactory.newPowder(depth, addToWorld);
            default:
                return itemFactory.newArrows(depth, addToWorld);
        }
    }
    ...
    public Item randomFood(int depth, int addToWorld) {
        switch (ExtraMaths.diceRoll(1, 5)) {
            case 1:
                return itemFactory.newRations(depth, addToWorld);
            case 2:
                return itemFactory.newRations(depth, addToWorld);
            case 3:
                return itemFactory.newRations(depth, addToWorld);
            case 4:
                return itemFactory.newRations(depth, addToWorld);
            case 5:
                return itemFactory.newPasty(depth, addToWorld);
            default:
                return itemFactory.newRations(depth, addToWorld);
        }
    }
    ...
    public Item randomMagicItem(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return randomPotion(depth, addToWorld);
            case 2:
                return randomScroll(depth, player, addToWorld);
            case 3:
                return randomWand(depth, player, addToWorld);
            case 4:
                return randomRing(depth, addToWorld);
            default:
                return randomPotion(depth, addToWorld);
        }
    }
    ...
    public Item randomWand(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 6)) {
            case 1:
                return randomEvocationWand(depth, player, addToWorld);
            case 2:
                return randomPyromancyWand(depth, player, addToWorld);
            case 3:
                return randomCryomancyWand(depth, player, addToWorld);
            case 4:
                return randomElectromancyWand(depth, player, addToWorld);
            case 5:
                return randomAlchemancyWand(depth, player, addToWorld);
            case 6:
                return randomFerromancyWand(depth, player, addToWorld);
    ...
    public Item randomEvocationWand(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return itemFactory.newMagicMissileWand(depth, player, addToWorld);
            case 2:
                return itemFactory.newForceBlastWand(depth, player, addToWorld);
            case 3:
                return itemFactory.newFindTrapsWand(depth, player, addToWorld);
            case 4:
                return itemFactory.newArchmagesAegisWand(depth, player, addToWorld);
    ...
    public Item randomPyromancyWand(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return itemFactory.newFireboltWand(depth, player, addToWorld);
            case 2:
                return itemFactory.newFlashfireWand(depth, player, addToWorld);
            case 3:
                return itemFactory.newBrazierBarrierWand(depth, player, addToWorld);
            case 4:
                return itemFactory.newPyrotechnicsWand(depth, player, addToWorld);
    ...
    public Item randomCryomancyWand(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return itemFactory.newFlashFreezeWand(depth, player, addToWorld);
            case 2:
                return itemFactory.newIceKnifeWand(depth, player, addToWorld);
            case 3:
                return itemFactory.newIceWallWand(depth, player, addToWorld);
            case 4:
                return itemFactory.newGlaciateWand(depth, player, addToWorld);
    ...
    public Item randomElectromancyWand(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return itemFactory.newChainLightningWand(depth, player, addToWorld);
            case 2:
                return itemFactory.newLightningLanceWand(depth, player, addToWorld);
            case 3:
                return itemFactory.newHasteWand(depth, player, addToWorld);
            case 4:
                return itemFactory.newStaticSurgeWand(depth, player, addToWorld);
    ...
    public Item randomAlchemancyWand(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return itemFactory.newAcidBlastWand(depth, player, addToWorld);
            case 2:
                return itemFactory.newToxicTransfusionWand(depth, player, addToWorld);
            case 3:
                return itemFactory.newRefluxBarrierWand(depth, player, addToWorld);
            case 4:
                return itemFactory.newLifetapWand(depth, player, addToWorld);
    ...
    public Item randomFerromancyWand(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 4)) {
            case 1:
                return itemFactory.newArmorStormWand(depth, player, addToWorld);
            case 2:
                return itemFactory.newWeaponBoltWand(depth, player, addToWorld);
            case 3:
                return itemFactory.newBladsWardWand(depth, player, addToWorld);
            case 4:
                return itemFactory.newInfuseUpgradeWand(depth, player, addToWorld);
    ...
    public Item randomRing(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 12)) {
            case 1:
                return itemFactory.newStrengthRing(depth, addToWorld);
            case 2:
                return itemFactory.newDexterityRing(depth, addToWorld);
            case 3:
                return itemFactory.newIntelligenceRing(depth, addToWorld);
            case 4:
                return itemFactory.newArmorRing(depth, addToWorld);
            case 5:
                return itemFactory.newFireResistanceRing(depth, addToWorld);
            case 6:
                return itemFactory.newFrostResistanceRing(depth, addToWorld);
            case 7:
                return itemFactory.newShockResistanceRing(depth, addToWorld);
            case 8:
                return itemFactory.newPoisonResistanceRing(depth, addToWorld);
            case 9:
                return itemFactory.newAcidResistanceRing(depth, addToWorld);
            case 10:
                return itemFactory.newMagicResistanceRing(depth, addToWorld);
            case 11:
                return itemFactory.newChaosResistanceRing(depth, addToWorld);
            case 12:
                return itemFactory.newVisionRing(depth, addToWorld);
            default:
                return itemFactory.newStrengthRing(depth, addToWorld);
        }
    }
    ...
    public Item randomScroll(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 7)) {
            case 1:
                return itemFactory.newScrollOfIdentify(depth, player, addToWorld);
            case 2:
                return itemFactory.newScrollOfMagicMapping(depth, player, addToWorld);
            case 3:
                return itemFactory.newScrollOfSummonMonsters(depth, player, addToWorld);
            case 4:
                return itemFactory.newScrollOfUpgrade(depth, player, addToWorld);
            case 5:
                return itemFactory.newScrollOfRemoveCurse(depth, player, addToWorld);
            case 6:
                return itemFactory.newScrollOfEnchantment(depth, player, addToWorld);
            case 7:
                return itemFactory.newScrollOfConfusion(depth, player, addToWorld);
            default:
                return itemFactory.newScrollOfIdentify(depth, player, addToWorld);
        }
    }
    ...
    public Item randomPotion(int depth, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 12)) {
            case 1:
                return itemFactory.newPotionOfPoison(depth, addToWorld);
            case 2:
                return itemFactory.newPotionOfGiantStrength(depth, addToWorld);
            case 3:
                return itemFactory.newPotionOfMana(depth, addToWorld);
            case 4:
                return itemFactory.newPotionOfInvisibility(depth, addToWorld);
            case 5:
                return itemFactory.newPotionOfParalysis(depth, addToWorld);
            case 6:
                return itemFactory.newPotionOfCausticGas(depth, addToWorld);
            case 7:
                return itemFactory.newPotionOfHealing(depth, addToWorld);
            case 8:
                return itemFactory.newPotionOfRestoration(depth, addToWorld);
            case 9:
                return itemFactory.newPotionOfMindVision(depth, addToWorld);
            case 10:
                return itemFactory.newPotionOfOvergrowth(depth, addToWorld);
            case 11:
                return itemFactory.newPotionOfCombustion(depth, addToWorld);
            case 12:
                return itemFactory.newPotionOfLevitation(depth, addToWorld);
            default:
                return itemFactory.newPotionOfHealing(depth, addToWorld);
        }
    }
    ...
    public Creature randomLesserMonster(int depth, Creature player, boolean addToWorld) {
        ...
        switch (ExtraMaths.diceRoll(1, 10)) {
            case 1:
                creature = randomFungus(depth, player, addToWorld);
                break;
            case 2:
                creature = randomFungus(depth, player, addToWorld);
                break;
            ...
            case 4:
                ...
                break;
            case 5:
                creature = randomSlime(depth, player, addToWorld);
                break;
            case 6:
                creature = creatureFactory.newBat(depth, addToWorld);
                break;
            case 7:
                creature = creatureFactory.newBat(depth, addToWorld);
                break;
            ...
            case 10:
                ...
                break;
            default:
                creature = creatureFactory.newFungus(depth, addToWorld);
                break;
        }
        if (ExtraMaths.diceRoll(1, 50) == 1) {
            creature =
                    creatureFactory.modifyCreatureDamageDealt(
                            creature, creatureFactory.modifierFactory.randomCreatureModifier());
        }
        if (ExtraMaths.diceRoll(1, 50) == 1) {
            creature =
                    creatureFactory.modifyCreatureResistsDamage(
                            creature, creatureFactory.modifierFactory.randomCreatureModifier());
        }
        return creature;
    }
    ...
    public Creature randomFungus(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 10)) {
            case 1:
                return creatureFactory.newBloodFungus(depth, player, addToWorld);
            default:
                return creatureFactory.newFungus(depth, addToWorld);
        }
    }
    ...
    public Creature randomSlime(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 16)) {
            case 1:
                return creatureFactory.newMagmaSlime(depth, player, addToWorld);
            case 2:
                return creatureFactory.newMetalSlime(depth, player, addToWorld);
            case 3:
                return creatureFactory.newThundercloudSlime(depth, player, addToWorld);
            default:
                return creatureFactory.newPinkSlime(depth, player, addToWorld);
        }
    }
    ...
    public Creature randomMediumMonster(int depth, Creature player, boolean addToWorld) {
        ...
        switch (ExtraMaths.diceRoll(1, 10)) {
            case 1:
                creature = randomSkeleton(depth, player, addToWorld);
                break;
            case 2:
                creature = randomSkeleton(depth, player, addToWorld);
                break;
            ...
            case 4:
                ...
                break;
            case 5:
                creature = randomGremlin(depth, player, addToWorld);
                break;
            case 6:
                creature = randomGremlin(depth, player, addToWorld);
                break;
            case 7:
                creature = randomConstruct(depth, player, addToWorld);
                break;
            case 8:
                creature = randomConstruct(depth, player, addToWorld);
                break;
            case 9:
                creature = creatureFactory.newGremlinSkirmisher(depth, player, addToWorld);
                break;
            case 10:
                creature = creatureFactory.newGremlinAlchemist(depth, player, addToWorld);
                break;
            default:
                creature = randomSkeleton(depth, player, addToWorld);
                break;
    ...
    public Creature randomConstruct(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 2)) {
            case 1:
                return creatureFactory.newAnimatedArmor(depth, player, addToWorld);
            case 2:
                return creatureFactory.newAnimatedWeapon(depth, player, addToWorld);
            default:
                return creatureFactory.newAnimatedWeapon(depth, player, addToWorld);
        }
    }
    ...
    public Creature randomSkeleton(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 15)) {
            case 1:
                return creatureFactory.newSkeletonCryomancer(depth, player, addToWorld);
            case 2:
                return creatureFactory.newSkeletonPyromancer(depth, player, addToWorld);
            case 3:
                return creatureFactory.newSkeletonElectromancer(depth, player, addToWorld);
            default:
                return creatureFactory.newSkeleton(depth, player, addToWorld);
        }
    }
    ...
    public Creature randomGremlin(int depth, Creature player, boolean addToWorld) {
        switch (ExtraMaths.diceRoll(1, 10)) {
            case 1:
                return creatureFactory.newGremlinSkirmisher(depth, player, addToWorld);
            case 2:
                return creatureFactory.newGremlinSkirmisher(depth, player, addToWorld);
            case 3:
                return creatureFactory.newGremlinAlchemist(depth, player, addToWorld);
            default:
                return creatureFactory.newGremlin(depth, player, addToWorld);
        }
    }
    ...
    public Creature randomGreaterMonster(int depth, Creature player, boolean addToWorld) {
        ...
        switch (ExtraMaths.diceRoll(1, 10)) {
            ...
            case 7:
                ...
                break;
            case 8:
                creature = creatureFactory.newMimic(depth, player, addToWorld);
                break;
            case 9:
                creature = creatureFactory.newCloaker(depth, player, addToWorld);
                break;
            case 10:
                creature = creatureFactory.newOgre(depth, player, addToWorld);
                break;
            default:
                creature = randomSkeleton(depth, player, addToWorld);
                break;
    ...
    public Creature randomChest(int depth, Creature player, boolean addToWorld) {
        switch (Dice.d20.roll()) {
            case 1:
                return creatureFactory.newMimic(depth, player, addToWorld);
            default:
                return creatureFactory.newChest(depth, player, addToWorld);
        }
    }
}
