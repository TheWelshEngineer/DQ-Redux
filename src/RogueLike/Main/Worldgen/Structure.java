...
public abstract class Structure {
    ...
    public final Optional<Structure> randomisePosition() {
        Optional<Point> loc =
                builder.pickRandomLocation(z, p -> this.setPosition(p).isCenterAcceptable());
    ...
    public final boolean isLocationAcceptable() {
        return isCenterAcceptable()
                && getReservedArea().noneMatch(builder::isStructureTileReserved);
    }
}
