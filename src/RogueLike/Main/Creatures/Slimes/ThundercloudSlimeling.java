...
public class ThundercloudSlimeling extends Creature{
	
	private static final long serialVersionUID = 2028922080675409476L;
	...
	public ThundercloudSlimeling( Creature player, String name, char glyph, Color color, int id, int depth) {
