...
public class MagmaSlime extends Creature{
	...
	private static final long serialVersionUID = -874199600899214637L;
	...
	public MagmaSlime( Creature player, String name, char glyph, Color color, int id, int depth) {
