...
public class ExtendedAsciiPanel extends JPanel {
    ...
    /**
     * Sets the distance from the left new text will be written to. This should be equal to or
     * greater than 0 and less than the the width in characters.
     *
    ...
    /**
     * Sets the distance from the top new text will be written to. This should be equal to or
    ...
    /**
     * Sets the x and y position of where new text will be written to. The origin (0,0) is the upper
     * left corner. The x should be equal to or greater than 0 and less than the the width in
     * characters. The y should be equal to or greater than 0 and less than the the height in
     * characters.
     *
    ...
    private void loadGlyphs(String[] sources) {
        ...
        for (int j = 0; j < sourceCount; j++) {
            ...
            for (int i = 0; i < 256; i++) {
                ...
                glyphs[i + (256 * j)] =
                        new BufferedImage(charWidth, charHeight, BufferedImage.TYPE_INT_ARGB);
                glyphs[i + (256 * j)]
                        .getGraphics()
                        .drawImage(
                                glyphSprite,
    ...
    /**
     * Clear the entire screen with the specified character and whatever the default foreground and
    ...
    /**
     * Clear the entire screen with the specified character and whatever the specified foreground
    ...
    public ExtendedAsciiPanel clear(char character, Color foreground, Color background) {
        ...
        return clear(
                character, 0, 0, widthInCharacters, heightInCharacters, foreground, background);
    }

    /**
     * Clear the section of the screen with the specified character and whatever the default
    ...
    public ExtendedAsciiPanel clear(char character, int x, int y, int width, int height) {
        ...
        return clear(
                character, x, y, width, height, defaultForegroundColor, defaultBackgroundColor);
    }

    /**
     * Clear the section of the screen with the specified character and whatever the specified
     * foreground and background colors are.
     *
     * @param character the character to write
     * @param x the distance from the left to begin writing from
    ...
    /**
     * Write a character to the cursor's position with the specified foreground color. This updates
     * the cursor's position but not the default foreground color.
     *
     * @param character the character to write
     * @param foreground the foreground color or null to use the default
     * @return this for convenient chaining of method calls
    ...
    /**
     * Write a character to the cursor's position with the specified foreground and background
     * colors. This updates the cursor's position but not the default foreground or background
     * colors.
     *
     * @param character the character to write
     * @param foreground the foreground color or null to use the default
    ...
    /**
     * Write a character to the specified position with the specified foreground color. This updates
     * the cursor's position but not the default foreground color.
     *
     * @param character the character to write
     * @param x the distance from the left to begin writing from
    ...
    /**
     * Write a character to the specified position with the specified foreground and background
     * colors. This updates the cursor's position but not the default foreground or background
     * colors.
     *
     * @param character the character to write
     ...
     * @return this for convenient chaining of method calls
     */
    public ExtendedAsciiPanel write(
            char character, int x, int y, Color foreground, Color background) {
        if (character < 0 || character >= glyphs.length)
            throw new IllegalArgumentException(
                    "character " + character + " must be within range [0," + glyphs.length + "].");
    ...
    /**
     * Write a string to the cursor's position with the specified foreground color. This updates the
     * cursor's position but not the default foreground color.
     *
     * @param string the string to write
     * @param foreground the foreground color or null to use the default
     * @return this for convenient chaining of method calls
    ...
    /**
     * Write a string to the specified position with the specified foreground color. This updates
     * the cursor's position but not the default foreground color.
     *
     * @param string the string to write
     * @param x the distance from the left to begin writing from
    ...
    /**
     * Write a TerminalText to the specified position. This updates the cursor's position but not
     * the default foreground or background colors.
     *
     ...
     */
    public ExtendedAsciiPanel write(
            String string, int x, int y, Color foreground, Color background) {
        if (string == null) throw new NullPointerException("string must not be null.");
    ...
    /**
     * Write a string to the center of the panel at the specified y position. This updates the
     * cursor's position.
     *
     * @param string the string to write
     * @param y the distance from the top to begin writing from
    ...
    /**
     * Write a string to the center of the panel at the specified y position with the specified
     * foreground color. This updates the cursor's position but not the default foreground color.
     *
     * @param string the string to write
     * @param y the distance from the top to begin writing from
     * @param foreground the foreground color or null to use the default
    ...
    /**
     * Write a string to the center of the panel at the specified y position with the specified
     * foreground and background colors. This updates the cursor's position but not the default
     ...
     * @return this for convenient chaining of method calls
     */
    public ExtendedAsciiPanel writeCenter(
            String string, int y, Color foreground, Color background) {
        if (string == null) throw new NullPointerException("string must not be null.");
